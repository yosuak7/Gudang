          ...
          <div class="col-md-12">
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                ...
                <!-- /.box-header -->
                <div class="container">
                  <form action="<?= site_url('user/submitcustomer') ?>" role="form" method="post">
                    <div class="box-body">
                      <div class="form-group">
                        <div class="form-group" style="margin-left:13px;display:inline;">
                          ...
                          <input required type="text" name="namacustomer" style="width:50%;margin-right: 50px;" class="form-control" id="nama_customer" placeholder="Nama Customer">
                        ...
                        <div class="box-footer" style="width:93%;">
                          <a type="button" class="btn btn-default" style="width:10%;margin-right:26%" href="<?= base_url('user/datacustomer') ?>" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
