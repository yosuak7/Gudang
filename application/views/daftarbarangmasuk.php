                                        ...
                                        <tr>
                                            <?php if (is_array($list_data)) { ?>
                                                <?php foreach ($list_data as $dd) : ?>
                                                    ...
                                                    <td><a type="button" class="btn btn-success" href="<?= base_url('beranda/detail_masuk/' . $dd->idtransaksi) ?>"  id="buttondetail" style="margin:auto;height:20%">Lihat</a></td>
                                                    <td><a type="button" class="btn btn-danger btn-delete" href="<?= base_url('beranda/delete_transaksi_masuk/' . $dd->idtransaksi) ?>" id="buttondelete" style="margin:auto;height:20%"><i class="fa fa-trash" aria-hidden="true"></a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php } else { ?>
